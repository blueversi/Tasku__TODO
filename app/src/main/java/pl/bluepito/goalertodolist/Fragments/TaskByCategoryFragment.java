...
public class TaskByCategoryFragment extends Fragment {

    private static final String TAG = "TaskByCategoryFragment";
    ...
    public TaskByCategoryFragment(int catId){
        this.catId =  catId;
    }
    ...
    public void allTaskView() {
        ...
        taskList = databaseHelper.getAllTasksByCategory(this.catId);
